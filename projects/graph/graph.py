...
#_____________________________________________________________
    def bft(self, starting_vertex):
        ...
        visited = set()
        # 3. While ther is stuff in the queue/stack
        while queue.size() >  0:
        #       Pop the first item
    ...
    def dft_recursive(self, starting_vertex, visited=None):
        ...
        # 2. put the starting point in that
        # Make a set to keep track of where we've been
        # 3. While ther is stuff in the queue/stacl
        #       Pop the first item
        #       If not visited
        #       DO THE THING
        #       For each edge in the item
    ...
    def bfs(self, starting_vertex, destination_vertex):
        ...
        queue = Queue()
        # 2. put the starting point in that
        #### enstack (start building a path) a list to use as our path 
        queue.enqueue([starting_vertex])
        # Make a set to keep track of where we've been
        visited = set()
        # 3. While ther is stuff in the queue/stack
        ...
        #           copy path to avoid pass by reference bug
                    new_path = list(path) #makes a copy rather than reference
